 ...
 */
/*
function dcc2011_body_class($left, $right) {
  if ($left != '' && $right != '') {
    $class = 'sidebars';
  }
  else {
 ...
 */
function dcc2011_preprocess_page(&$vars) {
 ...
 */
function dcc2011_preprocess_node(&$vars, $hook) {
...
function dcc2011_node_submitted($node) {
...
function dcc2011_comment_submitted($comment) {
...
/**
 * Implements theme_user_picture.
 * Forces use of imagecache preset.
 */
function dcc2011_user_picture($account, $size = 'thumb') {

  if (variable_get('user_pictures', 0)) {

    // Display the user's photo if available
    if ($account->picture && file_exists($account->picture)) {
      $picture = theme('imagecache', 'avatar_thumb', $account->picture);
    } // if
...
/*
function dcc2011_preprocess_comment_wrapper(&$vars) {
 ...
 */
/*
function dcc2011_get_ie_styles() {
  global $language;
